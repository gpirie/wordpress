...
function gpwd_custom_post_type_init() {
   ...
   $labels = array(
    ...
    $labels = array(
      ...
      'singular_name'       => _x( 'Snippets', 'Post Type Singular Name', 'text_domain' ),
      'menu_name'           => __( 'Snippets', 'text_domain' ),
      'name_admin_bar'      => __( 'Snippets', 'text_domain' ),
      'parent_item_colon'   => __( 'Parent Item:', 'text_domain' ),
      'all_items'           => __( 'All Items', 'text_domain' ),
      'add_new_item'        => __( 'Add Snippets Item', 'text_domain' ),
      'add_new'             => __( 'Add New', 'text_domain' ),
      'new_item'            => __( 'New Item', 'text_domain' ),
      'edit_item'           => __( 'Edit Item', 'text_domain' ),
      'update_item'         => __( 'Update Item', 'text_domain' ),
    ...
    $args = array(
      ...
      'description'         => __( 'Add details of Snippets items', 'text_domain' ),
      'labels'              => $labels,
      'supports'            => array( 'title', 'excerpt', 'editor', 'thumbnail', 'page-attributes', 'publicize', 'shortlinks' ),
      'hierarchical'        => false,
      'public'              => true,
