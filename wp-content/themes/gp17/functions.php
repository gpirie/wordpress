...
function gpwd_theme_scripts() 
{
	...
	if( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
		...
		wp_enqueue_style( 'gpwd-theme-shop-loop', GPWD_DIRECTORY_URI . '/assets/css/object.shoploop.css' ,null, GPWD_VERSION, 'screen' );
		wp_enqueue_style( 'gpwd-theme-shop-gallery', GPWD_DIRECTORY_URI . '/assets/css/object.productgallery.css' ,null, GPWD_VERSION, 'screen' );
	}
...
if( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
	require_once ( GPWD_THEME_INC . '/inc/woocommerce.php' );
}