<?php
	...
	function gpwd_pagination() {
	    ...
	    echo '<ul class="o-navigation u-overflow">' . "\n";

	    /** Previous Post Link */
	    if ( get_previous_posts_link() )
	        printf( '<li class="o-pagination__item">%s</li>' . "\n", get_previous_posts_link() );

	    /** Link to first page, plus ellipses if necessary */
	    if ( ! in_array( 1, $links ) ) {
	        $class = 1 == $paged ? ' class="o-pagination__item o-pagination__item--active"' : '';

	        printf( '<li%s><a class="o-pagination__link" href="%s">%s</a></li>' . "\n", $class, esc_url( get_pagenum_link( 1 ) ), '1' );

	        if ( ! in_array( 2, $links ) )
	            echo '<li class="o-pagination__item">…</li>';
	    }

	    /** Link to current page, plus 2 pages in either direction if necessary */
	    sort( $links );
	    foreach ( (array) $links as $link ) {
	        $class = $paged == $link ? ' class="o-pagination__item o-pagination__item--active"' : ' class="o-pagination__item"';
	    ...
	    if ( ! in_array( $max, $links ) ) {
	        ...
	        $class = $paged == $max ? ' class="o-pagination__item o-pagination__item--active"' : ' class="o-pagination__item"';
