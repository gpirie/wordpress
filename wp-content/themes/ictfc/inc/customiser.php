<?php
	...
	function ict_customiser( $wp_customize )
	{
		//Social Media
		$social_links = array();
		$social_links[] = array(
	...
	add_action('customize_register', 'ict_customiser');
