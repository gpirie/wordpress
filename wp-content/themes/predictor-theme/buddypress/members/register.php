...
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<form class="o-form o-form__register" action="" name="signup_form" id="signup_form" class="standard-form" method="post" enctype="multipart/form-data">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="o-registerform__section register-section" id="basic-details-section">
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-section o-registerform__section" id="profile-details-section">
			...
			<div class="submit u-clear">
				<input type="submit" class="o-button" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" />
			</div>
