<?php
	...
	function fp_customiser( $wp_customize )
	{
		//Social Media
		$social_links = array();
		$social_links[] = array(
		...
		$wp_customize->add_section( 'fp_theme_social' , array(
			'title'      => __( 'Social Media Accounts', 'fp-theme' ),
			'priority'   => 50,
		) );
		...
		//Footer
		$wp_customize->add_section( 'fp_theme_footer' , array(
			'title'      => __( 'Footer', 'fp-theme' ),
			'priority'   => 50,
		) );
		...
		$wp_customize->add_control( 'copyright', array(
			'label' => 'Copyright',
			'section' => 'fp_theme_footer',
			'settings' => 'copyright',
			'type' => 'text',
		) );

		//Socialize Networks
		$wp_customize->add_section( 'fp_theme_sharing' , array(
			'title'      => __( 'Social Sharing', 'fp-theme' ),
			'priority'   => 50,
		) );
	...
	add_action('customize_register', 'fp_customiser');
